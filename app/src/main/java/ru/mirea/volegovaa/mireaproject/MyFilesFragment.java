...
import ru.mirea.volegovaa.mireaproject.databinding.FragmentMyFilesBinding;
...
public class MyFilesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragment.show(getChildFragmentManager(), "volegov");
            }
        });
    ...
    public void openClicked() {
        ...
        {
            Snackbar.make(binding.getRoot(),"нет разрешения", Snackbar.LENGTH_SHORT).show();
        }
        Snackbar.make(binding.getRoot(),"завершено", Snackbar.LENGTH_SHORT).show();
    }
    ...
    public void readFileFromExternalStorage() {
        ...
        try {
            ...
            Log.d("Storage", String.format("Read from file %s failed", e.getMessage()));
        }
    }
    ...
    public void writeFileToExternalStorage() {
        ...
        try {
            ...
            Log.d("Storage", "Error writing " + file, e);
        } catch (Exception e) {
